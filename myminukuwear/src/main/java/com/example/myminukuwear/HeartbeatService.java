...
public class HeartbeatService extends Service implements SensorEventListener {
    ...
    public void onCreate() {
        ...
        Sensor mHeartRateSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_GRAVITY);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if(sensorEvent.sensor.getType()== Sensor.TYPE_GRAVITY && sensorEvent.values.length>0 ) {
